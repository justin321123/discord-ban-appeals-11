...
export async function handler(event, context) {
    ...
    return {
        statusCode: 303,
        headers: {
            "Location": `https://discord.com/api/oauth2/authorize?client_id=${encodeURIComponent(process.env.DISCORD_CLIENT_ID)}&redirect_uri=${encodeURIComponent(https://unban.demiddelbare.nl/.netlify/functions/oauth-callback)}&response_type=code&scope=identify&prompt=none&state=${state}`,
